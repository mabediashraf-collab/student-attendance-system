...
import 'teacher_warnings_screen.dart';
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(
              icon: Icon(Icons.warning_amber), label: 'Send Warnings'),
        ],
      ),
    );
  }
                ...
                children: [
                  CircleAvatar(
                    ...
                    backgroundImage: teacherData!['photo'] != null &&
                        ...
                        ? NetworkImage(
                            ImageHelper.getFullImageUrl(teacherData!['photo']))
                        : null,
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            Text('You have not been assigned to any classes yet',
              ...
              child: Column(
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    items: const [
                      DropdownMenuItem(
                          value: 'BOT', child: Text('Beginning of Term (BOT)')),
                      DropdownMenuItem(
                          value: 'MOT', child: Text('Mid-Term (MOT)')),
                      DropdownMenuItem(
                          value: 'EOT', child: Text('End of Term (EOT)')),
                    ],
                    onChanged: (value) =>
