...
class ApiService {
  ...
  Future<Map<String, dynamic>> getStudentsWithWarnings(int teacherId, int? classId) async {
    try {
      String url = '/attendance/check_and_warn.php?teacher_id=\';
      if (classId != null) {
        url += '&class_id=\';
      }
      final response = await http.get(Uri.parse(url));
      ...
      print('Get students with warnings error: \');
      return {'success': false, 'students': []};
    }
  }

  Future<Map<String, dynamic>> sendWarning(int studentId, int teacherId, String message, String warningType) async {
    try {
      final response = await http.post(
        Uri.parse('/attendance/send_warning.php'),
        headers: {'Content-Type': 'application/json'},
        body: jsonEncode({
          'student_id': studentId,
          'teacher_id': teacherId,
      ...
      print('Send warning error: \');
      return {'success': false, 'message': 'Error: \'};
    }
  }
}
  static Future<Map<String, dynamic>> getStudentsWithWarnings(int teacherId, int? classId) async {
    try {
      String url = '$baseUrl/attendance/check_and_warn.php?teacher_id=$teacherId';
      if (classId != null) {
      ...
      print('Get students with warnings error: $e');
      return {'success': false, 'students': []};
    }
  }

  static Future<Map<String, dynamic>> sendWarning(int studentId, int teacherId, String message, String warningType) async {
    try {
      final response = await http.post(
        Uri.parse('$baseUrl/attendance/send_warning.php'),
        headers: {'Content-Type': 'application/json'},
        body: jsonEncode({
          'student_id': studentId,
          'teacher_id': teacherId,
